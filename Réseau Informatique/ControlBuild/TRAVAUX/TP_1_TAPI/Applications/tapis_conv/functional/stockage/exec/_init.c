...
{
	stockage_In = self.Bool;
	self.Bool++;
	stockage_Out = self.Bool;
	self.Bool++;
	stockage_Nb_Pieces = self.Int;
	self.Int++;
}
...
void variablesInitialization(void)
{
	...
	CB_Char_Init(Mem, 0 + 3, 's');
	CB_Char_Init(Mem, 0 + 4, 't');
	CB_Char_Init(Mem, 0 + 5, 'o');
	CB_Char_Init(Mem, 0 + 6, 'c');
	CB_Char_Init(Mem, 0 + 7, 'k');
	CB_Char_Init(Mem, 0 + 8, 'a');
	CB_Char_Init(Mem, 0 + 9, 'g');
	CB_Char_Init(Mem, 0 + 10, 'e');
	CB_Char_Init(Mem, 0 + 11, '.');
	CB_Char_Init(Mem, 0 + 12, 'e');
	CB_Char_Init(Mem, 0 + 13, 'x');
	CB_Char_Init(Mem, 0 + 14, 'e');
