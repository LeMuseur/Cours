...
{
	capteur_tor_Position_IN = self.Float;
	self.Float++;
	capteur_tor_Position_Fixe = self.Float;
	self.Float++;
	capteur_tor_Etat = self.Bool;
	self.Bool++;
}
...
void variablesInitialization(void)
{
	...
	CB_Char_Init(Mem, 0 + 3, 'c');
	CB_Char_Init(Mem, 0 + 4, 'a');
	CB_Char_Init(Mem, 0 + 5, 'p');
	CB_Char_Init(Mem, 0 + 6, 't');
	CB_Char_Init(Mem, 0 + 7, 'e');
	CB_Char_Init(Mem, 0 + 8, 'u');
	CB_Char_Init(Mem, 0 + 9, 'r');
	CB_Char_Init(Mem, 0 + 10, '_');
	CB_Char_Init(Mem, 0 + 11, 't');
	CB_Char_Init(Mem, 0 + 12, 'o');
	CB_Char_Init(Mem, 0 + 13, 'r');
	CB_Char_Init(Mem, 0 + 14, '.');
	CB_Char_Init(Mem, 0 + 15, 'e');
	CB_Char_Init(Mem, 0 + 16, 'x');
	CB_Char_Init(Mem, 0 + 17, 'e');
